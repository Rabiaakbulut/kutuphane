...
namespace WebKutuphane.Utils
{
    public class BaseController : System.Web.Mvc.Controller //Controller sınıfından miras aldık
    {
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            bool isControl = controllerName == "Kitap" && actionName == "Details" ||controllerName == "Kitap" && actionName == "KitapAl" || controllerName=="Home" || controllerName == "Uye" && actionName == "UyeProfil" || controllerName == "Yorum" && actionName == "Delete";
